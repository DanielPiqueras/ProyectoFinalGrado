        ...
        <div class="container-fluid ">
            ...
            <header class="fixed-top border-bottom border-secondary py-2 bg-dark text-white">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm text-center">
                        <a class="btn btn-secondary" href="inicio_usuario.php">Inicio</a>
                        <a class="btn btn-secondary" href="registro_usuario.php">Registrar</a>
                    </div>
                </div>
            </header>
            <main class="jumbotron main">
                <?php include '../maquetacion/informacion.php' ?>
            </main>
